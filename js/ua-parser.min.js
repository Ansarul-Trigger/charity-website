(function(h, f) {
    var y = function(a, b) {
            var c = {},
                e;
            for (e in a) c[e] = b[e] && 0 === b[e].length % 2 ? b[e].concat(a[e]) : a[e];
            return c
        },
        p = function(a) {
        ...
        u = function(a, b) {
            return "string" === typeof a ? -1 !== m(b).indexOf(m(a)) : !1
        },
        m = function(a) {
            return a.toLowerCase()
        },
        r = function(a, b) {
            if ("string" === typeof a) return a = a.replace(/^\s\s*/, "").replace(/\s\s*$/, ""), "undefined" === typeof b ? a : a.substring(0, 255)
        },
        n = function(a, b) {
            for (var c = 0, e, v, g, d, h, k; c < b.length && !h;) {
                var l =
                    b[c],
                    m = b[c + 1];
                for (e = v = 0; e < l.length && !h;)
                    if (h = l[e++].exec(a))
                        for (g = 0; g < m.length; g++) k = h[++v], d = m[g], "object" === typeof d && 0 < d.length ? 2 === d.length ? this[d[0]] = "function" == typeof d[1] ? d[1].call(this, k) : d[1] : 3 === d.length ? this[d[0]] = "function" !== typeof d[1] || d[1].exec && d[1].test ? k ? k.replace(d[1], d[2]) : f : k ? d[1].call(this, k, d[2]) : f : 4 === d.length && (this[d[0]] = k ? d[3].call(this, k.replace(d[1], d[2])) : f) : this[d] = k ? k : f;
                c += 2
            }
        },
        t = function(a, b) {
        ...
        g = function(a, b) {
            ...
            if (!(this instanceof g)) return (new g(a, b)).getResult();
            var c = a || ("undefined" !== typeof h && h.navigator && h.navigator.userAgent ? h.navigator.userAgent : ""),
                e = b ? y(x, b) : x;
            this.getBrowser = function() {
                var a = {};
                a.name = f;
                a.version = f;
                n.call(a, c, e.browser);
                var b = a.version;
                b = "string" ===
                    typeof b ? b.replace(/[^\d\.]/g, "").split(".")[0] : f;
                a.major = b;
                return a
            };
            ...
            this.setUA = function(a) {
                c = "string" === typeof a && 255 < a.length ? r(a, 255) : a;
                return this
            };
            this.setUA(c);
            return this
    ...
    g.VERSION = "1.0.2";
    g.BROWSER = p(["name", "version", "major"]);
    g.CPU = p(["architecture"]);
    g.DEVICE = p("model vendor type console mobile smarttv tablet wearable embedded".split(" "));
    g.ENGINE = g.OS = p(["name", "version"]);
    "undefined" !== typeof exports ? ("undefined" !== typeof module && module.exports && (exports = module.exports =
        g), exports.UAParser = g) : "function" === typeof define && define.amd ? define(function() {
        return g
    }) : "undefined" !== typeof h && (h.UAParser = g);
    var l = "undefined" !== typeof h && (h.jQuery || h.Zepto);
    if (l && !l.ua) {
        var q = new g;
        l.ua = q.getResult();
        l.ua.get = function() {
